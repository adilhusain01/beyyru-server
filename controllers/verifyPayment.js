...
const verifyPayment = async (req, res) => {
  const { razorpay_order_id, razorpay_payment_id, razorpay_signature, orderId, user } = req.body;
  ...
  if (generatedSignature === razorpay_signature) {
    ...
    res.json({ status: 'success', orderId: razorpay_order_id, order: updatedOrder });
  } else {
    // Payment failed
