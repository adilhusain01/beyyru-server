  ...
  exports.createOrder = async (req, res) => {
    try {
      const { products, userId, shippingAddress, paymentMethod, discountAmount } = req.body;

      console.log( products, userId, shippingAddress, paymentMethod, discountAmount, "helloe")
